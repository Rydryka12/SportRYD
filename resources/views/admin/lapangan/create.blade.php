                            ...
                            <div class="col-md-6 col-12">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" id="nama_lapang" name="nama_lapang"
                                           ...
                                           value="{{ old('nama_lapang') }}" placeholder="Masukkan Nama Lapangan" required>
                            ...
                            <div class="col-12">
                                <div class="form-group mb-3">
                                    ...
                                    <textarea name="deskripsi" id="deskripsi"
                                              ...
                                              rows="3" placeholder="Masukkan Deskripsi Lapangan">{{ old('deskripsi') }}</textarea>
                            ...
                            <div class="col-md-6 col-12">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="number" id="tarif_per_jam" name="tarif_per_jam"
                                           ...
                                           value="{{ old('tarif_per_jam') }}" placeholder="Contoh: 60000" min="0" required>
